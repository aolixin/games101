...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    for (auto& light : lights)
    {
        ...
        Vector3f ld = kd.cwiseProduct(light.intensity/r)*std::max(0.0f,normal.normalized().dot(light_dir.normalized()));
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "E:/wenjian/visual project/game101_cmake/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("E:/wenjian/visual project/game101_cmake/models/spot/spot_triangulated_good.obj");
